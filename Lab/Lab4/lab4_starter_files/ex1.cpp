...
{
    // TODO:
    float flour_enough = flour_remain - num_pies * 250;
	if(flour_enough < 0)  throw (-flour_enough);
}
...
{
    // TODO:
    int eggs_enough = eggs_remain - num_pies;
    if(eggs_enough < 0) throw (-eggs_enough);
}
...
{
    // TODO:
    int apples_enough = apples_remain - num_pies * 2;
    if(apples_enough < 0) throw (-apples_enough);
}
...
int main(int argc, char* argv[])
{
    ...
    try 
    {
        ...
        catch( /* TODO: */MARKET2_CLOSED closed )
        {
        ...
        {
            cout << "Apples in market2 are not enough. You still need " << /* TODO: */ lack << " more." << endl;
            flag = 0;
        }  
    }
    catch( /* TODO: */ MARKET1_CLOSED closed)
    {
        cout << "market1 is closed!" << endl;
        flag = 0;
    }
    catch( /* TODO: */ float lack)
    {
        cout << "Flour in market1 is not enough. You still need " << /* TODO: */ lack << " grams more." << endl;
        flag = 0;
    }
    catch( /* TODO: */ int lack)
    {
        cout << "Eggs in market1 are not enough. You still need " << /* TODO: */ lack << " more." << endl;
        flag = 0;
    }
